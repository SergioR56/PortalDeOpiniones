...
//Importamos la función que valida los esquemas y las funciones que guardan y eliminan fotos del disco.
const validateSchema = require('../../utils/validateSchema');
const savePhoto = require('../../utils/savePhoto');
const deletePhoto = require('../../utils/deletePhoto');

//Importamos el esquema de Joi.
const updateAvatarSchema = require('../../schemas/users/updateAvatarSchema');
...
const editAvatarController = async (req, res, next) => {
    try {
        ...
        await validateSchema(updateAvatarSchema, req.files || {});
        ...
        //Variable donde almacenamos el nombre con el que vamos a guardar el avatar en la carpeta "uploads".
