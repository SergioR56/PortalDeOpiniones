...
//Creamos un esquema para validar imágenes. De esta forma podremos reutilizar este esquema en los esquemas de validación de los endpoints que requieran imágenes.
const imgSchema = joi
    .object({
